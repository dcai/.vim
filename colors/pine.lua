...
local search_hl =
  { fg = colors.white, bg = colors.darkmagenta, cterm = styles.bold }
...
local custom = {
  ...
  StatusLineProjectAccent = {
    bg = colors.nicelightgreen,
    fg = colors.nicedarkgreen,
  },
  StatusLineHighlight = {
    bg = colors.nicelightgreen,
    fg = colors.nicedarkgreen,
