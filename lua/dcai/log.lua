...
M.setup = function(userconfig)
  ...
  log_instance.new = function(config)
    ...
    local outfile =
      string.format('%s/%s.log', config.logdir or vim.g.log_dir, config.plugin)
    ...
    for i, x in ipairs(config.modes) do
      log_instance[x.name] = function(...)
        return log_at_level(i, x, make_string, ...)
      end

      log_instance[('fmt_%s'):format(x.name)] = function()
  ...
  log_instance.new(userconfig or {})
  -- }}}
